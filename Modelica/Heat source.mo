model F1
  ...
  Buildings.Fluid.Sources.MassFlowSource_T boundary1(redeclare package Medium = Buildings.Media.Air, T = 293.15, m_flow = 100, nPorts = 3) annotation(
    Placement(transformation(origin = {-48, 88}, extent = {{8, -8}, {-8, 8}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT bou1(redeclare package Medium = Buildings.Media.Air, nPorts = 3) annotation(
    Placement(transformation(origin = {-316, 90}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Fluid.Fittings.TeeJunctionIdeal teeJunctionIdeal111(redeclare package Medium = Buildings.Media.Water) annotation(
    Placement(transformation(origin = {97, -79}, extent = {{9, -11}, {-9, 11}}, rotation = 90)));
  ...
  Modelica.Blocks.Sources.Constant const111(k = 1) annotation(
    Placement(transformation(origin = {-106, -100}, extent = {{8, -8}, {-8, 8}})));
  ...
  Modelica.Blocks.Sources.Constant const1(k = 0)  annotation(
    Placement(transformation(origin = {33, 199}, extent = {{-5, -5}, {5, 5}})));
  ParSolCol parSolCol annotation(
    Placement(transformation(origin = {92, 136}, extent = {{-20, -20}, {20, 20}})));
  Buildings.Fluid.SolarCollectors.Controls.SolarPumpController pumCon annotation(
    Placement(transformation(origin = {-8, 120}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  ...
  connect(const111.y, fan11.m_flow_in) annotation(
    Line(points = {{-115, -100}, {-115, -50}, {-283, -50}, {-283, -59}}, color = {0, 0, 127}));
  connect(const111.y, valveLinear11.opening) annotation(
    Line(points = {{-115, -100}, {-115, -62}, {-234.2, -62}, {-234.2, -70}}, color = {0, 0, 127}));
  ...
  connect(const111.y, valveLinear111.opening) annotation(
    Line(points = {{-115, -100}, {-208.1, -100}, {-208.1, -124}, {-232.1, -124}}, color = {0, 0, 127}));
  connect(const111.y, fan111.m_flow_in) annotation(
    Line(points = {{-115, -100}, {-208.1, -100}, {-208.1, -114}, {-282.1, -114}}, color = {0, 0, 127}));
  ...
  connect(boundary1.ports[1], heaPum.port_a2) annotation(
    Line(points = {{-56, 88}, {-114, 88}, {-114, 68}, {-132, 68}}, color = {0, 127, 255}));
  connect(bou1.ports[1], heaPum.port_b2) annotation(
    Line(points = {{-306, 90}, {-186, 90}, {-186, 68}, {-158, 68}}, color = {0, 127, 255}));
  connect(boundary1.ports[2], heaPum1.port_a2) annotation(
    Line(points = {{-56, 88}, {-114, 88}, {-114, 34}, {-132, 34}}, color = {0, 127, 255}));
  connect(bou1.ports[2], heaPum1.port_b2) annotation(
    Line(points = {{-306, 90}, {-186, 90}, {-186, 34}, {-158, 34}}, color = {0, 127, 255}));
  connect(boundary1.ports[3], heaPum11.port_a2) annotation(
    Line(points = {{-56, 88}, {-114, 88}, {-114, 2}, {-130, 2}}, color = {0, 127, 255}));
  connect(bou1.ports[3], heaPum11.port_b2) annotation(
    Line(points = {{-306, 90}, {-186, 90}, {-186, 2}, {-158, 2}}, color = {0, 127, 255}));
  ...
  connect(TIn.port_b, parSolCol.port_a) annotation(
    Line(points = {{56, 114}, {78, 114}, {78, 136}, {82, 136}}, color = {0, 127, 255}));
  connect(parSolCol.port_b, TOut.port_a) annotation(
    Line(points = {{102, 136}, {106, 136}, {106, 108}}, color = {0, 127, 255}));
  connect(const1.y, parSolCol.shaCoe_in) annotation(
    Line(points = {{38.5, 199}, {56, 199}, {56, 138}, {71, 138}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[5], parSolCol.SolDir) annotation(
    Line(points = {{-18, 170}, {66, 170}, {66, 144}, {71, 144}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[6], parSolCol.SolDifHori) annotation(
    Line(points = {{-18, 170}, {56, 170}, {56, 143}, {63.5, 143}, {63.5, 141}, {71, 141}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[2], parSolCol.Tenv) annotation(
    Line(points = {{-18, 170}, {56, 170}, {56, 135}, {71, 135}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[1], parSolCol.Time) annotation(
    Line(points = {{-18, 170}, {56, 170}, {56, 130}, {71, 130}}, color = {0, 0, 127}));
  connect(pumCon.y, gain.u) annotation(
    Line(points = {{-8, 108}, {-8, 80}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[5], pumCon.HSolDirN) annotation(
    Line(points = {{-18, 170}, {-2, 170}, {-2, 132}}, color = {0, 0, 127}));
  annotation(
    Diagram(coordinateSystem(extent = {{-1000, -1000}, {1000, 1000}}), graphics = {Rectangle(origin = {80, 157}, extent = {{0, 1}, {0, -1}})}),
